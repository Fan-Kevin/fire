...
static char labels[COCO_CLASS_NUM][30] = {"car","truck", "bus","plate"};
...
/************wzp***************/
    // if(xmin0<xmin1 && ymin0<ymin1 && xmax0>xmax1 && ymax0 >ymax1){
    //     return 1;
    // }
    // else if(xmin0>xmin1 && ymin0>ymin1 && xmax0<xmax1 && ymax0 < ymax1){
    //     return 1;
    // }
                   ...
                   float threshold, uint8_t zp, float scale)
{
    ...
    for (int a = 0; a < 3; a++)
    {
        for (int i = 0; i < grid_h; i++)
        {
            ...
            {
                uint8_t box_confidence = input[(COCO_PROP_BOX_SIZE * a + 4) * grid_len + i * grid_w + j];
                 ...
                 coco_detect_result_group_t *group)
{
	...
	*/
    ...
    int validCount0 = 0;
    validCount0 = process_u8(input2, (int *)anchor0, grid_h0, grid_w0, model_in_h, model_in_w,
                          stride0, filterBoxes, boxesScore, classId, conf_threshold, qnt_zps[2], qnt_scales[2]);
    ...
    int validCount2 = 0;
    validCount2 = process_u8(input0, (int *)anchor2, grid_h2, grid_w2, model_in_h, model_in_w,
                          stride2, filterBoxes, boxesScore, classId, conf_threshold, qnt_zps[0], qnt_scales[0]);
